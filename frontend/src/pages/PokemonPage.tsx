    ...
    return (
        <div className='bg-primary w-full h-screen '>
            <div className='w-full h-64 relative'>
                <img src={pokemon.image} alt="pokemon" className='w-40 m-auto absolute  bottom-0 left-[calc((100%-160px)/2)] animate-[bounce_4s_ease-in-out_infinite]'/>
            </div>
            <div className='bg-third h-[calc(100%-256px)] rounded-2xl p-4'>
                <h1 className='text-2xl w-full text-center text-secondary'>{pokemon.name}</h1>
