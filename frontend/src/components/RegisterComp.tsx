...
interface FormValues {
  ...
  function RegisterComp() {
   ...
   <form className='text-center max-w-screen-md w-3/4 m-auto p-5
        ...
        <div className='m-5'>
          <input className='w-full h-12 px-2.5 rounded-md border-solid border-2 md:w-[300px] lg:w-[400px]' type="text" id="UserName" name="UserName" value={values.UserName} onChange={handleChange} placeholder='Enter your Username'/>
        </div>
        <div className='m-5'>
        ...
        <div className='m-5'>
        <Button className='bg-primary w-3/4 h-12 rounded-md font-bold text-secondary md:w-[200px] lg:w-[300px]' type="submit">Register</Button>
        </div>
      </form>
    );
  }
